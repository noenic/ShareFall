...
Being familiar with PHP, I decided to rewrite a good part of the backend in PHP, it makes the whole process both faster and more laborious.
click here if you are interested in the better version (PHP binary required)
